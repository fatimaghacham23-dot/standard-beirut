  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-16 h-16 cursor-pointer rounded-full group will-change-transform z-50 bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl shadow-black/40"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 will-change-transform bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl shadow-black/40 rounded-full"
            style={{
